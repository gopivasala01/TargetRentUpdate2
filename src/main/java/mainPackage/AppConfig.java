...
public class AppConfig 
{
   ...
   public static String quertyToFetchPendingBuildingsListFromETLSource = "Select Company,[Building/Unit Abbreviation],TargetRent,TargetDeposit from automation.TargetRent where Format(CompletedON,'yyyy-MM-dd') = '2023-02-09' and status ='Failed' ";//where Status = 'Pending'"; 
   ...
   public static String toEmail =  "gopi.v@beetlerim.com";  //"msanfilippo@homeriver.com,amesa@homeriver.com,kespinoza@homeriver.com,mjackson@homeriver.com";
